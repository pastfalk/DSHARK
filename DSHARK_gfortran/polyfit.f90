...
!! \param x array contaning the wavenumbers of the previously derived solutions and the subsequent wavenumber
...
subroutine polyfit(x,y,omega_start)
  ...
  !note that x = 'wavenumber k' and y = 'frequency omega'
