...
This is a manual for the Fortran-90 code DSHARK containing a short description of the program, an explanation of the input parameters, and some advices for an efficient usage of the code. Note that this code version is adapted to the Intel Fortran Compiler (ifort) and has been tested with Intel Fortran Compiler 16.0.
